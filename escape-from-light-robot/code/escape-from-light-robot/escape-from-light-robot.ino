...
AF_DCMotor motor_d(1); //MOTOR DC NA LIGAÇÃO M1 DO SHIELD
AF_DCMotor motor_e(2); //MOTOR DC NA LIGAÇÃO M2 DO SHIELD
...
void loop() {
  ...
  //VERIFICA O VALOR LIDO PELO LDR. O VALOR 900 FOI ESTABELECIDO DE ACORDO COM AS CONDIÇÕES DE ILUMINAÇÃO DO DIA E DO LOCAL ONDE O ROBÔ FOI MONTADO. 
